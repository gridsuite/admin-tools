...
from functions.clean_orphan_contingency_lists import delete_orphan_contingency_lists
from functions.clean_orphan_filters import delete_orphan_filters
from functions.clean_orphan_networks import delete_orphan_network
...
parser.add_argument(("--mode"), help="test mode (default) will not execute any modification request", choices=[ScriptMode.TEST.value, ScriptMode.EXEC.value], nargs='?', type=str, const=ScriptMode.TEST, default=ScriptMode.TEST)
