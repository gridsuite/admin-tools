...
# Elastic REST API
# cf. https://www.elastic.co/guide/en/elasticsearch/reference/current/rest-apis.html

parser = argparse.ArgumentParser(description='Send requests (REST APIs) to the ES server', )
     
parser.add_argument("-m", "--method", help="request method to execute on ES server", required=True)
...
elasticsearch_ip, elasticsearch_url = get_eleasticsearch_host(constant.DIRECTORY_SERVER_HOSTNAME)
