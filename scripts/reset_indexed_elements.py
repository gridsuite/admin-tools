...
from functions.indexes.directoryElements import reindex_elements, recreate_elements_index
...
print("\n")
print("Number of indexed directory elements before reindexation (name: " + elements_index_name + ") = " + get_nb_indexed_elements())
print("---------------------------------------------------------")
if not dry_run:
    recreate_elements_index()
    print("Directory elements reindexation processing...")
    reindex_elements()
    print("End of reindexation")
    print("Number of indexed directory elements after reindexation (name: " + elements_index_name + ") = " + get_nb_indexed_elements())
else:
