...
DYNAMIC_MAPPING_SERVER_URL = HTTP_PROTOCOL + DYNAMIC_MAPPING_SERVER_HOSTNAME
...
DELETE_STUDY = STUDY_SERVER_URL + "/studies"
...
GET_SUPERVISION_LOADED_STUDIES = STUDY_SERVER_URL + "/supervision/studies/loaded"
GET_DYNAMIC_MAPPING_FILTERS = DYNAMIC_MAPPING_SERVER_URL + "/supervision/filters"

GET_CONTINGENCY_LISTS = ACTIONS_SERVER_URL + "/supervision/contingency-lists"
GET_CONTINGENCY_LISTS_METADATA = ACTIONS_SERVER_URL + "/contingency-lists/metadata"
DELETE_CONTINGENCY_LISTS = ACTIONS_SERVER_URL + "/contingency-lists"

GET_FILTERS = FILTER_SERVER_URL + "/supervision/filters"
DELETE_FILTERS = FILTER_SERVER_URL + "/filters"

DELETE_COMPUTATION_RESULTS = STUDY_SERVER_URL + "/supervision/computation/results"

# DIRECTORY ELEMENT TYPES
STUDY_ELEMENT_TYPE = "STUDY"
...
UNLOAD_STUDY = STUDY_SERVER_URL + "/supervision/studies/{studyUuid}/invalidate"
...
GRAFANA_COOKIES = {}
GRAFANA_HEADERS = {'X-Disable-Provenance': 'true', 'Cookie' : ''}
